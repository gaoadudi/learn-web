...
<div class="col-md-5 col-sm-9 col-xs-12 mb-5">
	...
	<form method="POST" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			@if (old('photo')!=null)
			<img width="50" height="50" src="img/{{ old('photo') }}">
			@endif
			<input type="file" name="photo" class="form-control mt-1" value="{{ old('photo') }}">
			@if ($errors->has("photo"))
		...
		<div class="form-group">
			...
			<input type="text" name="jobtitle" class="form-control underlined" value="{{ old('jobtitle') }}">
		...
		<div class="form-group">
			...
			<input type="text" name="cellphone" class="form-control underlined" value="{{ old('cellphone') }}">
		...
		<div class="form-group">
			...
			<input type="text" name="email" class="form-control underlined" value="{{ old('email') }}">
			@if ($errors->has("email"))
