...
<div class="col-md-5 col-sm-9 col-xs-12 mb-5">
	...
	<form method="POST">
		...
		<div class="form-group">
			...
			<input type="text" name="username" class="form-control underlined" value="{{ old('username') }}">
		...
		<div class="form-group">
			...
			<input type="email" name="email" class="form-control underlined" value="{{ old('email') }}">
			@if ($errors->has("email"))
		...
		<div class="form-group">
			...
			<select name="role" class="form-control">
				...
				<option value="2" <?php if (old('role')==2) echo 'selected'; ?>>Normal</option>
			</select>
		</div>
		<!--div class="form-group">
