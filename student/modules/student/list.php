...
<div class="container">
	<div class="row text-center justify-content-center mt-3">
		...
		<form class="input-group mb-3 col-md-9 col-lg-9" method="POST" action="<?php echo create_link(array('m'=>'student', 'a'=>'list.php')); ?>">
		...
		<table class="table table-bordered mt-2">
			...
			<tbody>
				<?php foreach ($data as $value) { ?>
					<tr>
						...
						<td>
							<form method="POST" action="<?php echo create_link(array('m'=>'student', 'a'=>'delete.php')); ?>">
								<input class="btn btn-light btn-sm mb-1" onclick="window.location='<?php echo create_link(array('m'=>'student', 'a'=>'edit.php', 'id'=>$value['id'])); ?>'" type="button" value="SỬA"/> | 
			...
			<tfoot>
				<tr>
					<td colspan="5"> 
						<a class="btn btn-primary" href="<?php echo create_link(array('m'=>'student', 'a'=>'add.php')); ?>">Thêm sinh viên</a>
					</td>
				</tr>
			</tfoot>
		</table>
